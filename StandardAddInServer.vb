...
Namespace CIWLinkParameters2
    <ProgIdAttribute("CIWLinkParameters2.StandardAddInServer"),
    GuidAttribute("706eb45b-8b5a-4ef2-9f85-9fa321f9f89e")>
...
#Region "ApplicationAddInServer Members"
        ...
        Public Sub Activate(ByVal addInSiteObject As Inventor.ApplicationAddInSite, ByVal firstTime As Boolean) Implements Inventor.ApplicationAddInServer.Activate
            ...
            Dim largeIcon As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.icons8_link_100)
            Dim smallIcon As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.icons8_link_50)

            Dim largeIconPDF As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.pdf)
            Dim smallIconPDF As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.pdf)

            Dim controlDefs As Inventor.ControlDefinitions = g_inventorApplication.CommandManager.ControlDefinitions
            m_sampleButton = controlDefs.AddButtonDefinition("Link" & vbCrLf & "Parameters", "$safeprojectname$", CommandTypesEnum.kShapeEditCmdType, AddInClientID, "Link Parameters", "Link Parameters", smallIcon, largeIcon)
            m_sampleButton2 = controlDefs.AddButtonDefinition("Save PDF", "SavePDF", CommandTypesEnum.kShapeEditCmdType, AddInClientID, "Save PDF", "Save PDF", smallIconPDF, largeIconPDF)
...
#Region "User interface definition"
        ...
        Private Sub AddToUserInterface()
            ...
            '' Create a new panel.
            Dim customPanel As RibbonPanel = toolsTab.RibbonPanels.Add("Crown Iron Works", "$safeprojectname$", AddInClientID)

            Dim customDWGPanel As RibbonPanel = DWGtoolsTab.RibbonPanels.Add("Crown Iron Works", "CIWSavePDF", AddInClientID)


            '' Add a button.
            customPanel.CommandControls.AddButton(m_sampleButton, True)

            customDWGPanel.CommandControls.AddButton(m_sampleButton2, True)
        End Sub
        ...
        Private Sub m_sampleButton_OnExecute(Context As NameValueMap) Handles m_sampleButton.OnExecute
            Dim Form_LinkParameters As New Form_LinkParameters
            Form_LinkParameters.ShowDialog()


        End Sub

        Private Sub m_sampleButton2_OnExecute(Context As NameValueMap) Handles m_sampleButton2.OnExecute
            Dim Form_SavePDF As New Form_SavePDF
            Form_SavePDF.ShowDialog()
...
#Region "Function to get the add-in client ID."
    ...
    Public Function AddInClientID() As String
        Dim guid As String = ""
        Try
            Dim t As Type = GetType(CIWLinkParameters2.StandardAddInServer)
